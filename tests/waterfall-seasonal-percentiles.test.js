...
test("USGS observation-normal percentile response parses for the requested day",()=>{
  ...
  assert.deepEqual(stats,{p25:150,p50:225,p75:340,p90:500,sample_days:54,window_days:1,month:9,day:5});
});

test("string-encoded percentile arrays also parse",()=>{
  const payload={results:[{monitoring_location_id:"USGS-04045500",normal_type:"DOY",time_of_year:"09-05",percentiles:"[10,25,50,75,90]",values:"[100,150,225,340,500]",sample_count:54}]};
  const stats=api.parseStatistics(payload,new Date("2026-09-05T12:00:00Z"));
