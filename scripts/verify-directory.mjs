...
assert.match(html,/data-tool-id="elk-rut"/,'elk rut card missing from national directory');
assert.match(html,/href="\/national-tools\/elk-rut\/"/,'elk rut tool must have a crawlable directory link');
